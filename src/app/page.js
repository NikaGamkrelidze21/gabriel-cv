...
export default function Home() {
  return (
    <main className="w-full grid grid-cols-2 grid-flow-row gap-x-10 gap-y-20 justify-center text-[var(--custom-brown)] px-[20%]">
      <header className='flex w-full grid grid-cols-2 gap-40 col-span-2 h-[100vh]'>
        <AboutMe
          name={'Gabriel'}
          lastname={'tsintsadze'}
          status={'Developer'}
